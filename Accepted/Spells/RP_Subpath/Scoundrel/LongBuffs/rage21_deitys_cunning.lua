...
deitys_cunning = {
	on_learn = function(player)
		player.registry["learned_deitys_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_deitys_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("deitys_cunning") then
			player:setDuration("deitys_cunning", 0)
			return
		end
