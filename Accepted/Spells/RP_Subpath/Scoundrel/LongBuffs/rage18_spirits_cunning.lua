...
spirits_cunning = {
	on_learn = function(player)
		player.registry["learned_spirits_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_spirits_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("spirits_cunning") then
			player:setDuration("spirits_cunning", 0)
			return
		end
