...
silhouettes_cunning = {
	on_learn = function(player)
		player.registry["learned_silhouettes_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_silhouettes_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("silhouettes_cunning") then
			player:setDuration("silhouettes_cunning", 0)
			return
		end
