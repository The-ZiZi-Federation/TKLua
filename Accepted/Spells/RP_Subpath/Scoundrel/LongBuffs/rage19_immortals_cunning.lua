...
immortals_cunning = {
	on_learn = function(player)
		player.registry["learned_immortals_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_immortals_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("immortals_cunning") then
			player:setDuration("immortals_cunning", 0)
			return
		end
