...
deaths_cunning = {
	on_learn = function(player)
		player.registry["learned_deaths_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_deaths_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("deaths_cunning") then
			player:setDuration("deaths_cunning", 0)
			return
		end
