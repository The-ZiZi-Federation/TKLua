...
djinns_cunning = {
	on_learn = function(player)
		player.registry["learned_djinns_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_djinns_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("djinns_cunning") then
			player:setDuration("djinns_cunning", 0)
			return
		end
