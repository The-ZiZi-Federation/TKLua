...
champion_duelist = {
	on_learn = function(player)
		player.registry["learned_champion_duelist"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_champion_duelist"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("champion_duelist") then
			player:setDuration("champion_duelist", 0)
			return
		end
	...
	requirements = function(player)
		...
		local desc = {
			"Champion Duelist is a spell that hones your fighting technique to increase your attack damage!\nReplaces Kingdom Duelist.",
			txt
		}
