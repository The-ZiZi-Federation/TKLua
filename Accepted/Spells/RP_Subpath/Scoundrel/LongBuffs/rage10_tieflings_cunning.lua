...
tieflings_cunning = {
	on_learn = function(player)
		player.registry["learned_tieflings_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_tieflings_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("tieflings_cunning") then
			player:setDuration("tieflings_cunning", 0)
			return
		end
