...
demigods_cunning = {
	on_learn = function(player)
		player.registry["learned_demigods_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_demigods_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("demigods_cunning") then
			player:setDuration("demigods_cunning", 0)
			return
		end
