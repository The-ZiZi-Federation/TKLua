...
reapers_cunning = {
	on_learn = function(player)
		player.registry["learned_reapers_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_reapers_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("reapers_cunning") then
			player:setDuration("reapers_cunning", 0)
			return
		end
