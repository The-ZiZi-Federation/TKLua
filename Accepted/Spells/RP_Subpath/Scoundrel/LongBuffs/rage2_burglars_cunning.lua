...
burglars_cunning = {
	on_learn = function(player)
		player.registry["learned_burglars_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_burglars_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("burglars_cunning") then
			player:setDuration("burglars_cunning", 0)
			return
		end
