...
shades_cunning = {
	on_learn = function(player)
		player.registry["learned_shades_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_shades_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("shades_cunning") then
			player:setDuration("shades_cunning", 0)
			return
		end
