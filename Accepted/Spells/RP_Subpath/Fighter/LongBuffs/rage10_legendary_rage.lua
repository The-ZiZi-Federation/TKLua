...
legendary_rage = {
	on_learn = function(player)
		player.registry["learned_legendary_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_legendary_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("legendary_rage") then
			player:setDuration("legendary_rage", 0)
			return
		end
