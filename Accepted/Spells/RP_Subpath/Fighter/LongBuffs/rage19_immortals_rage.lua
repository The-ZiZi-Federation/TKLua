...
immortals_rage = {
	on_learn = function(player)
		player.registry["learned_immortals_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_immortals_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("immortals_rage") then
			player:setDuration("immortals_rage", 0)
			return
		end
