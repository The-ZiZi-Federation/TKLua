...
superhuman_rage = {
	on_learn = function(player)
		player.registry["learned_superhuman_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_superhuman_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("superhuman_rage") then
			player:setDuration("superhuman_rage", 0)
			return
		end
