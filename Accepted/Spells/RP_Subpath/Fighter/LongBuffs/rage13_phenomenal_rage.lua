...
phenomenal_rage = {
	on_learn = function(player)
		player.registry["learned_phenomenal_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_phenomenal_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("phenomenal_rage") then
			player:setDuration("phenomenal_rage", 0)
			return
		end
