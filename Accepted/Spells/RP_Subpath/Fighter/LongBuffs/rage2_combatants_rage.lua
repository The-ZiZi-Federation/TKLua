...
combatants_rage = {
	on_learn = function(player)
		player.registry["learned_combatants_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_combatants_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("combatants_rage") then
			player:setDuration("combatants_rage", 0)
			return
		end
