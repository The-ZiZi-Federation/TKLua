room_hellfire = {
	...
	requirements = function(player)
		...
		local ia = {7500, 5, 1}
		local d = {
			"Explode\n\nAn elemental attack of fire, at the risk of hurting and possibly killing yourself. Damage and Aether depends on your will and mana",
			"You shall have to sacrifice (5) Bottled rum, (1) Golden helm and 7500 coins to learn this ability"
		}
		return l, i, ia, d
	end
}
