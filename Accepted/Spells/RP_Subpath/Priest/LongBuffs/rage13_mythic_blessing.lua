...
mythic_blessing = {
	on_learn = function(player)
		player.registry["learned_mythic_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_mythic_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("mythic_blessing") then
			player:setDuration("mythic_blessing", 0)
			return
		end
