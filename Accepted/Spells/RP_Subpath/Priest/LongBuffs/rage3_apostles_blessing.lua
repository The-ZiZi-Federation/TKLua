...
apostles_blessing = {
	on_learn = function(player)
		player.registry["learned_apostles_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_apostles_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("apostles_blessing") then
			player:setDuration("apostles_blessing", 0)
			return
		end
