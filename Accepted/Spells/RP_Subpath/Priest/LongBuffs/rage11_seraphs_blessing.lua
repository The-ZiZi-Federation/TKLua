...
seraphs_blessing = {
	on_learn = function(player)
		player.registry["learned_seraphs_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_seraphs_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("seraphs_blessing") then
			player:setDuration("seraphs_blessing", 0)
			return
		end
