...
divine_blessing = {
	on_learn = function(player)
		player.registry["learned_divine_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_divine_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("divine_blessing") then
			player:setDuration("divine_blessing", 0)
			return
		end
