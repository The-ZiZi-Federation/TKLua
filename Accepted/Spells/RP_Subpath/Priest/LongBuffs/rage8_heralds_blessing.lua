...
heralds_blessing = {
	on_learn = function(player)
		player.registry["learned_heralds_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_heralds_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("heralds_blessing") then
			player:setDuration("heralds_blessing", 0)
			return
		end
