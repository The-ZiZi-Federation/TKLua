...
zealots_blessing = {
	on_learn = function(player)
		player.registry["learned_zealots_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_zealots_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("zealots_blessing") then
			player:setDuration("zealots_blessing", 0)
			return
		end
