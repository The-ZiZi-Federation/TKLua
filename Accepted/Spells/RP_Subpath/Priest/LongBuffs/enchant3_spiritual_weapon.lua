...
spiritual_weapon = {
	on_learn = function(player)
		player.registry["learned_spiritual_weapon"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_spiritual_weapon"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("spiritual_weapon") then
			player:setDuration("spiritual_weapon", 0)
			return
		end
