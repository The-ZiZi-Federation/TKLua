...
sphinxs_cunning = {
	on_learn = function(player)
		player.registry["learned_sphinxs_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_sphinxs_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("sphinxs_cunning") then
			player:setDuration("sphinxs_cunning", 0)
			return
		end
