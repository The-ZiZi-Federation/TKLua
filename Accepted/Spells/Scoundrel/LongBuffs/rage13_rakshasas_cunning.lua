...
rakshasas_cunning = {
	on_learn = function(player)
		player.registry["learned_rakshasas_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_rakshasas_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("rakshasas_cunning") then
			player:setDuration("rakshasas_cunning", 0)
			return
		end
