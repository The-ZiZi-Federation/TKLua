...
wraiths_cunning = {
	on_learn = function(player)
		player.registry["learned_wraiths_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_wraiths_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("wraiths_cunning") then
			player:setDuration("wraiths_cunning", 0)
			return
		end
