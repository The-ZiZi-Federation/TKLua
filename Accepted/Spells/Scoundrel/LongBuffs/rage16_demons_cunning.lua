...
demons_cunning = {
	on_learn = function(player)
		player.registry["learned_demons_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_demons_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("demons_cunning") then
			player:setDuration("demons_cunning", 0)
			return
		end
