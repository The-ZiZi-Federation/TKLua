...
hellcats_cunning = {
	on_learn = function(player)
		player.registry["learned_hellcats_cunning"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_hellcats_cunning"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("hellcats_cunning") then
			player:setDuration("hellcats_cunning", 0)
			return
		end
