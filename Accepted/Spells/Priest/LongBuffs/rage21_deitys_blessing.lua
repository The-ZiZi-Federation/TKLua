...
deitys_blessing = {
	on_learn = function(player)
		player.registry["learned_deitys_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_deitys_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("deitys_blessing") then
			player:setDuration("deitys_blessing", 0)
			return
		end
