...
marvelous_blessing = {
	on_learn = function(player)
		player.registry["learned_marvelous_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_marvelous_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("marvelous_blessing") then
			player:setDuration("marvelous_blessing", 0)
			return
		end
