...
evangelists_blessing = {
	on_learn = function(player)
		player.registry["learned_evangelists_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_evangelists_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("evangelists_blessing") then
			player:setDuration("evangelists_blessing", 0)
			return
		end
