...
fairys_blessing = {
	on_learn = function(player)
		player.registry["learned_fairys_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_fairys_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("fairys_blessing") then
			player:setDuration("fairys_blessing", 0)
			return
		end
