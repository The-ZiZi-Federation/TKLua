...
believers_blessing = {
	on_learn = function(player)
		player.registry["learned_believers_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_believers_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("believers_blessing") then
			player:setDuration("believers_blessing", 0)
			return
		end
