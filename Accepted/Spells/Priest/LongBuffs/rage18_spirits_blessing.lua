...
spirits_blessing = {
	on_learn = function(player)
		player.registry["learned_spirits_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_spirits_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("spirits_blessing") then
			player:setDuration("spirits_blessing", 0)
			return
		end
