...
celestials_blessing = {
	on_learn = function(player)
		player.registry["learned_celestials_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_celestials_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("celestials_blessing") then
			player:setDuration("celestials_blessing", 0)
			return
		end
