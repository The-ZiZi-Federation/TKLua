...
demigods_blessing = {
	on_learn = function(player)
		player.registry["learned_demigods_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_demigods_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("demigods_blessing") then
			player:setDuration("demigods_blessing", 0)
			return
		end
