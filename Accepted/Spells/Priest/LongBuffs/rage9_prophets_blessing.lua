...
prophets_blessing = {
	on_learn = function(player)
		player.registry["learned_prophets_blessing"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_prophets_blessing"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("prophets_blessing") then
			player:setDuration("prophets_blessing", 0)
			return
		end
