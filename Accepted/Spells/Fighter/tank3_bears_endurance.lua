...
bears_endurance = {
	...
	on_forget = function(player)
		player.registry["learned_bears_endurance"] = 0
	end,
	cast = function(player, target)
		...
		if player:hasDuration("bears_endurance") then
			alreadyCast(player)
			return
		end
	...
	requirements = function(player)
		...
		local desc = {
			"Invoke the spirit of the Bear to significantly increase your endurance for a short time.\n\nReplaces Tiger's Endurance.",
			txt
		}
