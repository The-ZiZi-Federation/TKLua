...
demigods_rage = {
	on_learn = function(player)
		player.registry["learned_demigods_rage"] = 1
	end,
	on_forget = function(player)
		player.registry["learned_demigods_rage"] = 0
	end,
	cast = function(player)
		...
		if player:hasDuration("demigods_rage") then
			player:setDuration("demigods_rage", 0)
			return
		end
