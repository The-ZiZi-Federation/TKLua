...
shockwave_lv3 = {
	on_learn = function(player)
		player.registry["learned_shockwave_lv3"] = 1
	...
	on_forget = function(player)
		player.registry["learned_shockwave_lv3"] = 0
	end,
	...
	requirements = function(player)
		...
		local desc = {
			"Shockwave Lv3 will blast your foes with a wave of lightning from your hands!\n\nReplaces Shockwave Lv2",
			txt
		}
