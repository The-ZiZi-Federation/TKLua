...
burning_hands_lv2 = {
	on_learn = function(player)
		player.registry["learned_burning_hands_lv2"] = 1
	...
	on_forget = function(player)
		player.registry["learned_burning_hands_lv2"] = 0
	end,
	...
	requirements = function(player)
		...
		local desc = {
			"Burning Hands Lv2 will send a cone of fire infront of you burning your enemies alive!\n\nReplaces Burning Hands Lv1",
			txt
		}
