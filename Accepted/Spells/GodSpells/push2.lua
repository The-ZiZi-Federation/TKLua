push2 = {
	cast = function(player, target)
		...
		if (player.side == 0) then
			...
			if
				(#checkplayernorth + #checkmobnorth + #checknpcnorth == 0 and
					player:objectCanMove(player.x, player.y - 2, 0) == true and
					getPass(player.m, player.x, player.y - 2) == 0)
			 then
			...
			elseif
				(#checkplayereast + #checkmobeast + #checknpceast == 0 and
					player:objectCanMove(player.x + 1, player.y - 1, 1) == true and
					getPass(player.m, player.x + 1, player.y - 1) == 0)
			 then
				player:sendMinitext("You cast Push.")
				player:playSound(337)
				...
				d[1]:sendAnimation(10)
			elseif
				(#checkplayerwest + #checkmobwest + #checknpcwest == 0 and
					player:objectCanMove(player.x - 1, player.y - 1, 3) == true and
					getPass(player.m, player.x - 1, player.y - 1) == 0)
			 then
				player:sendMinitext("You cast Push.")
				player:playSound(337)
		...
		elseif (player.side == 1) then
			...
			if
				(#checkplayereast + #checkmobeast + #checknpceast == 0 and player:objectCanMove(player.x + 2, player.y, 1) == true and
					getPass(player.m, player.x + 2, player.y) == 0)
			 then
				player:sendMinitext("You cast Push.")
				player:playSound(337)
			...
			elseif
				(#checkplayernorth + #checkmobnorth + #checknpcnorth == 0 and
					player:objectCanMove(player.x + 1, player.y - 1, 0) == true and
					getPass(player.m, player.x + 1, player.y - 1) == 0)
			 then
				player:sendMinitext("You cast Push.")
				player:playSound(337)
				...
				d[1]:sendAnimation(10)
			elseif
				(#checkplayersouth + #checkmobsouth + #checknpcsouth == 0 and
					player:objectCanMove(player.x + 1, player.y + 1, 2) == true and
					player:objectCanMove(player.x + 1, player.y, 0) == true and
					getPass(player.m, player.x + 1, player.y + 1) == 0)
			 then
				player:sendMinitext("You cast Push.")
				player:playSound(337)
		...
		elseif (player.side == 2) then
			...
			if
				(#checkplayersouth + #checkmobsouth + #checknpcsouth == 0 and
					player:objectCanMove(player.x, player.y + 2, 2) == true and
					player:objectCanMove(player.x, player.y + 1, 0) == true and
					getPass(player.m, player.x, player.y + 2) == 0)
			 then
		...
		elseif (player.side == 3) then
			...
			if
				(#checkplayerwest + #checkmobwest + #checknpcwest == 0 and player:objectCanMove(player.x - 2, player.y, 3) == true and
					getPass(player.m, player.x - 2, player.y) == 0)
			 then
				player:sendMinitext("You cast Sneak attack.")
				player:playSound(337)
	...
	requirements = function(player)
		...
		local d = {
			"Push\n\nPush your enemy.",
			"You shall sacrifice (100) Chestnut, (10) Amethyst, (1) Squirrel fur and 2000 coins to learn this ability."
		}
		return l, i, ia, d
	end
}
