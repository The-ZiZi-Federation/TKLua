samurai_trainer = {
	click = async(
		function(player, npc)
			...
			if player.class == samurai and player.mark < 1 and (player.baseHealth >= 457500 or player.baseMagic >= 457500) then
			...
			if player.baseClass == 1 and player.class < 5 then
				table.insert(opts, "I want to be a Samurai")
			end
			...
			if menu == "I want to be a Samurai" then
				...
				elseif player.level == 110 then
					player:dialogSeq(
						{
							t,
							name .. "Becoming a Samurai is choosing the life of the sword.",
							name .. "We hold the equalizer in any situation. Strength, Stamina, Speed, Swing power. ",
							name .. "Joining us is not to be a Samurai. You join only if you want to be the Greatest Samurai!"
						},
						1
					)
					...
					if confirm == "Yes" then
						player:dialogSeq(
							{
								t,
								name .. "Alright then. Welcome Ronin. I can't say that I envy your next steps.",
								name .. "Live by the sword. Die by the sword. Never back down!"
							},
							1
						)
