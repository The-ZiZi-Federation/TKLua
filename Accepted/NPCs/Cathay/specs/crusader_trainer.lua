crusader_trainer = {
	click = async(
		function(player, npc)
			...
			if player.class == crusader and player.mark < 1 and (player.baseHealth >= 457500 or player.baseMagic >= 457500) then
			...
			if player.baseClass == 4 and player.class < 5 then
				table.insert(opts, "I want to be a Crusader")
			end
			...
			if menu == "I want to be a Crusader" then
				...
				elseif player.level == 110 then
					player:dialogSeq(
						{
							t,
							name .. "It is not everyday someone comes in these doors looking to join the fight against evil.",
							name .. "I wont lie to you. It feel's like the world is losing to evil.",
							name .. "If you join this fight, you are in it for life. FOR ASAK!"
						},
						1
					)
					...
					if confirm == "Yes" then
						player:dialogSeq(
							{
								t,
								name .. "Well now it's about to be official. All Seeing All Knowing God. With all your infinite wisdom!",
								name .. "I call upon you to annoint this new soldier to the cause. Let's fight Evil EVERYWHERE!"
							},
							1
						)
