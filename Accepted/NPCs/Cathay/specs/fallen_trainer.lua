fallen_trainer = {
	click = async(
		function(player, npc)
			...
			if player.class == fallen and player.mark < 1 and (player.baseHealth >= 457500 or player.baseMagic >= 457500) then
			...
			if player.baseClass == 4 and player.class < 5 then
				table.insert(opts, "I want to be a Fallen")
			end
			...
			if menu == "I want to be a Fallen" then
				...
				elseif player.level == 110 then
					player:dialogSeq(
						{
							t,
							name .. "Not finding what you sought in the priesthood? I can tell.",
							name .. "You don't seem like white armor and vows of purity are your calling.",
							name .. "You are meant for something different. Something greater. We know the way, you only need to follow."
						},
						1
					)
					...
					if confirm == "Yes" then
						player:dialogSeq(
							{
								t,
								name .. "This was pre-ordained by very great forces. You coming here was no accident.",
								name .. "Go! Spread the word, begin your new life, Heretic."
							},
							1
						)
