bard_trainer = {
	click = async(
		function(player, npc)
			...
			if player.class == bard and player.mark < 1 and (player.baseHealth >= 457500 or player.baseMagic >= 457500) then
			...
			if player.baseClass == 2 and player.class < 5 then
				table.insert(opts, "I want to be a Bard")
			end
			...
			if menu == "I want to be a Bard" then
				...
				elseif player.level == 110 then
					player:dialogSeq(
						{
							t,
							name .. "Let me guess, you're not Dexterous enough to be an Assassin...",
							name .. "No, you're not strong enough to be a Mercenary...",
							name .. "No, I can see it. You are smart enough to know this is the best life for people like us."
						},
						1
					)
					...
					if confirm == "Yes" then
						player:dialogSeq(
							{
								t,
								name .. "Welcome to the show. Hope you like music.",
								name .. "You'll be singing sweet melodies in no time!"
							},
							1
						)
