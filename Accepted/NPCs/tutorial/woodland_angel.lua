	...
	onSayClick = async(
		function(player, npc)
			...
			if speech == "finish" then
				...
				local choice = player:menuSeq("Where do you wish to live?", {"Neutral", "Koguryo", "Buya", "I don't know yet"}, {})
				...
				elseif choice == 5 then
					...
					player:dialogSeq({t, "You must choose Koguryo or Buya currently."}, 0)
					return
				end
