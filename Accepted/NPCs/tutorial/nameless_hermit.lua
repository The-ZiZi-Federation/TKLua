	...
	click = async(
		function(player, npc)
			...
			if player:hasItem("aged_wine", 1) == true then
				local choice =
					player:menuSeq("Are you willing to part with that Aged wine?", {"Of course!", "I kind of need it."}, {})
				...
				elseif choice == 2 then
					player:dialogSeq({t, 'The hermit sighs. "That\'s too bad."'}, 1)
				end
			end
			...
			elseif choice == 2 then
				player:dialogSeq({t, "Okay. Say, I'd stay on this side of the lava were I you."}, 0)
			end
		end
	)
}
