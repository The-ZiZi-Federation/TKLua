...
botcheck = {
	init = function(player)
		...
		player:msg(0, "Please read this carefully or your character will be jailed.", player.ID)
		player:msg(0, "Your character is being checked for AFK hunting.", player.ID)
		player:msg(0, "If you closed the window accidentally, please wait for the next one to appear.", player.ID)
		player:msg(0, "You will have 180 seconds to respond to the messages.", player.ID)
		player:msg(
			0,
