welcomeNmail = {
	send = function(player)
		...
		mail = mail .. "==================================\n"
		mail = mail .. "Thanks for reading and we hope you enjoy your time spent with us on RoSTK!\n"

		mail2 = "===[ Welcome to RoSTK ]===\n"
		mail2 = mail2 .. "==================================\n"
		...
		mail2 = mail2 .. "\n"
		mail2 = mail2 .. "==================================\n"
		mail2 = mail2 .. "Thanks for reading and we hope you enjoy your time spent with us on RoSTK!\n"

		player:sendMail(player.name, "Controls and Hotkeys", mail2 .. "")
		player:sendMail(player.name, "Welcome to RoSTK!", mail .. "")
	end
}
