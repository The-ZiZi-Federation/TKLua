sendWorldMap = function(player, origin)
	...
	table.insert(destinations, {x0 = 765, y0 = 400, name = "Buya", m = 1012, x1 = 1, y1 = 11})
	table.insert(destinations, {x0 = 950, y0 = 470, name = "Hausson", m = 1025, x1 = 10, y1 = 8})
	table.insert(destinations, {x0 = 722, y0 = 550, name = "Kugnae", m = 1011, x1 = 18, y1 = 14})
	table.insert(destinations, {x0 = 650, y0 = 660, name = "Nagnang", m = 2520, x1 = 8, y1 = 8})
	table.insert(
		destinations,
		{
			x0 = 380,
